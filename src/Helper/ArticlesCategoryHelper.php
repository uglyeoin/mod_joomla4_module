...
abstract class ArticlesCategoryHelper
{
	...
	public static function getList(&$params)
	{
		...
		foreach ($items as &$item)
		{
			...
			if ($show_introtext)
			{
				$item->introtext = HTMLHelper::_('content.prepare', $item->introtext, '', 'mod_joomla4_module.content');
	...
	public static function groupByTags($list, $direction = 'ksort')
	{
		...
		if ($untagged)
		{
			$grouped['MOD_JOOMLA4_MODULE_UNTAGGED'] = $untagged;
		}
